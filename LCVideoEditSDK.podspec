#
#  Be sure to run `pod spec lint LCVideoEditSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "iWolf" => "727388890@qq.com" }
  # Or just: spec.author    = "iWolf"
  # spec.authors            = { "iWolf" => "727388890@qq.com" }
  # spec.social_media_url   = "https://twitter.com/iWolf"
